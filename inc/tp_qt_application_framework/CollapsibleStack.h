#ifndef tp_qt_application_framework_CollapsibleStack_h
#define tp_qt_application_framework_CollapsibleStack_h
...
public:
  ...
  */
  CollapsibleStack(DisplayManager* displayManager, QWidget* parent=nullptr);
  ...
  */
  virtual ~CollapsibleStack();

  //################################################################################################
  //! Save the state of this widget
  /*!
  Save the state of this CollapsibleStack and all of its children.
